...
{
    private readonly IPsicologiaService _service;
    private readonly IConsultaService _consultaService;

    public PsicologiaController(
        IPsicologiaService service,
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        return Ok(
            ...
            {
                Success = true,
                Message = "Registros de psicologia encontrados",
                Data = registros
            }
        );
    }
...
)
    {
        ...
        return Ok(
            ...
            {
                Success = true,
                Message = "Registro de psicologia criado com sucesso",
                Data = registro
            }
        );
    }
